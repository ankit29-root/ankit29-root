### 👋 Hi, I'm Ankit Prajapati (@ankit29-root)

I'm a passionate tech enthusiast who loves exploring the world of **web development**, **cybersecurity**, and everything in between.

- 🌱 Currently learning: **Cybersecurity**, **Ethical Hacking**, and **Bug Bounty**
- 💻 Skills: HTML, CSS, JavaScript, Git, Linux, Node.js (basic), Python (basic)
- 🚀 Projects: Web apps, portfolio site, basic security tools (see pinned repos!)
- 🔗 Portfolio: [My Website](https://ankit-29.netlify.app)
- 🧩 I'm also on [LeetCode](https://leetcode.com/u/ankit7864/)
